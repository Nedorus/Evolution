...
Namespace Modifier
    ...
    Public MustInherit Class ModifierBaseImpl
        ...
        Public MustOverride ReadOnly Property ChangeOperator As IModifier.ModifierOperator Implements IModifier.ChangeOperator
        ...
        Public Sub ReadXml(reader As XmlReader) Implements IXmlSerializable.ReadXml
            'empty because this is handled by the ModifierFactoryImpl
        ...
        Public Sub WriteXml(writer As XmlWriter) Implements IXmlSerializable.WriteXml
            ...
            End If
            If FirstArg IsNot Nothing Then
                FirstArg.WriteXml(writer)
            End If
            If SecondArg IsNot Nothing Then
